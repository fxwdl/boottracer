...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Subscript,Superscript,About,Scayt,Cut,Copy,Paste,Anchor';
	...
	config.extraPlugins= 'colorbutton,font,image2';

	config.filebrowserImageUploadUrl="http://localhost:8888/moon-web/hello/upload";
