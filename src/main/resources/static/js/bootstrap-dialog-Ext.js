//http://blog.csdn.net/qing_gee/article/details/70239322
//例子中还有一个加载自定义页面的功能，但代码有误，没粘过来
//弹出错误提示的登录框
...
// 以下代码用于远程加载页面或者模板，动态进行Post提交。对于页面要共享多个父页面调用的，应该用这种方式。
// http://www.cnblogs.com/cryst/p/5842953.html
// http://www.cnblogs.com/cryst/p/6020283.html
                            ...
                            $.HTTP.obj({
                                ...
                                success: function (json) {
                                    if (showOpt.autoClose) {
                                        dialogItself.close();
                                        $.NOTIFY.showSuccess(showOpt.successTitle, showOpt.successMessage);
                                    } else {
